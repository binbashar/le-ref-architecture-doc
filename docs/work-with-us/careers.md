...
!!! info "What You'll Work On (our tech stack) :man_technologist: :woman_technologist: :rocket:"
    - [x] [**Infrastructure as Code (IaC) Library**](/user-guide/infra-as-code-library/overview/)
        ...
        languages: *OpenTofu, Terraform, Ansible, Helm, Dockerfiles, Python, Bash and Makefiles*.
...
!!! important "Nice to have background"
    ...
    - :heavy_plus_sign: :one: Note that even if we're concerned with prior experience like AWS, Linux, OpenTofu and/or Terraform, 
